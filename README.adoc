...
----
$ git clone git@github.com:lholmquist/fu-vertx
...
. Stop your booster.
. Make your change (e.g. edit link:https://github.com/lholmquist/fu-vertx/edit/master/{fileLocation}[`{fileLocation}`]).
